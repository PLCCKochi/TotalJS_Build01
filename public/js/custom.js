function opennewsearch(){
    window.open('https://www.google.com/search?q=' + document.getElementById('searchtext').value + ' site:@{repository.data.server.host}', '_blank');
}
...
jQuery(document).ready(function($) {
    ...
    if ($('#map_contact_1').length) {
        ...
        console.log('GMap js failed. Log:-');
        console.log(err);
